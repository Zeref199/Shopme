...
public class CategoryController {
    ...
    public String listByPage(@PathVariable(name = "pageNum") int pageNum, String sortDir, String keyword,  Model model){
        ...
        long startCount = (long) (pageNum - 1) * service.ROOT_CATEGORIES_PER_PAGE + 1;
    ...
    public String editCategories(@PathVariable(name = "id") Integer id, Model model, RedirectAttributes redirectAttributes){
        try {
