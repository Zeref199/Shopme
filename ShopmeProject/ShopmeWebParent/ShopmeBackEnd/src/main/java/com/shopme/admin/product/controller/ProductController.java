...
public class ProductController {
    ...
    public String saveProduct(Product product,
        ...
        ProductSaveHelper.saveUploadedImages(mainImageMultipart, extraImageMultipart, saveProduct);

        ProductSaveHelper.deleteExtraImagesRemovedFromForm(product);
    ...
    public String editProduct(@PathVariable("id") Integer id, Model model, RedirectAttributes ra, @AuthenticationPrincipal ShopmeUserDetails loggedUser){
        try{
